/*
	...
	This supports the following devices:
		...
		ST Focuser
		Preliminary STX Support
 
    Version 4.60B9 - November 18, 2008

	(c)1995-2008 - Santa Barbara Instrument Group
...
/*
    ...
    TEMP_STATUS_REQUEST - Used with the Query Temperature Status command.
...
*/
typedef enum { TEMP_STATUS_STANDARD, TEMP_STATUS_ADVANCED } QUERY_TEMP_STATUS_REQUEST;
...
typedef enum { DCP_USB_FIFO_ENABLE, DCP_CALL_JOURNAL_ENABLE,
	...
	DCP_VERT_FLUSH_CONTROL_ENABLE, DCP_ETHERNET_PIPELINE_ENABLE, DCP_FAST_LINK, DCP_LAST } DRIVER_CONTROL_PARAM;
...
typedef enum { CFWSEL_UNKNOWN, CFWSEL_CFW2, CFWSEL_CFW5, CFWSEL_CFW8, CFWSEL_CFWL,
	...
	CFWSEL_CFW10_SERIAL, CFWSEL_CFW9, CFWSEL_CFWL8, CFWSEL_CFWL8G, CFWSEL_CFW1603 } CFW_MODEL_SELECT;
...
#define MIN_STX_EXPOSURE	 1	/* ST-X always uses electronic shutter for exposure timing */
