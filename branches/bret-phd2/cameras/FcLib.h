...
// 11/15/07
//
//      • added a log file capability
//
//          Starfish_Log
//
//      • fixes for buffer overrun problem on USB reception
//          several routines did not allocat a large enough buffer
//          for the possible Rx message size
//
// 12/02/07
//
//      • added support for image filters
//          - fcUsb_cmd_setImageFilter routine to set it up
//          - fcUsb_cmd_getRawFrame routine will implement filter that is set.
//          - gCameraImageFilter global stores the current filter setting
//
// 12/08/07
//
//      • changed fcImage_calcFullFrameRowAvgForRow routine to throw out lowest and highest
//        pixels values before computing the average
//
// 12/14/07
//
//      • added set camera gain and set camera offset routines for original starfish
//      • added call to get the black level pedestal of the camera
//
// 2/28/08
//      • added additional time to look for a final camera after the RAW was found
//        Will look every second for up till 10 seconds before giving up.
...
namespace FcCamSpace
{
    ...
    public:
        ...
        static __declspec(dllexport) void   fcUsb_init(void);
        ...
        //
        static __declspec(dllexport) void   fcUsb_setLogging(bool loggingState);


        // This is the framework close routine and needs to be called just before application termination
        static __declspec(dllexport) void   fcUsb_close(void);
        ...
        //
        static __declspec(dllexport) int fcUsb_FindCameras(void);
        ...
        //
        static __declspec(dllexport) int fcUsb_GetFindCamsState(void);



        // call this routine to know how long it will take for the fcUsb_FindCameras routine to complete.
        //
        static __declspec(dllexport) float fcUsb_GetFindCamsPercentComplete(void);
        ...
        //
        static __declspec(dllexport) int fcUsb_GetNumCameras(void);
        ...
        //
        static __declspec(dllexport) bool fcUsb_haveCamera(void);
        ...
        //
        static __declspec(dllexport) int fcUsb_GetCameraSerialNum(int camNum);
        ...
        // valid camNum is 1 -> fcUsb_GetNumCameras()
        //
        static __declspec(dllexport) int fcUsb_GetCameraVendorID(int camNum);
        ...
        // valid camNum is 1 -> fcUsb_GetNumCameras()
        //
        static __declspec(dllexport) int fcUsb_GetCameraProductID(int camNum);




        static __declspec(dllexport) int fcUsb_cmd_nop(int camNum);



        // send the rst command to the starfish camera
        //
        static __declspec(dllexport) int fcUsb_cmd_rst(int camNum);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_getinfo(int camNum, fc_camInfo *camInfo);
        ...
        // valid camNum is 1 -> fcUsb_GetNumCameras()
        //
        static __declspec(dllexport) int fcUsb_cmd_setRegister(int camNum, UInt16 regAddress, UInt16 dataValue);
        ...
        //
        static __declspec(dllexport) UInt16 fcUsb_cmd_getRegister(int camNum, UInt16 regAddress);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_setIntegrationTime(int camNum, UInt32 theTime);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_setGuiderIntegrationTime(int camNum, UInt32 theTime);
        ...
        // valid camNum is 1 -> fcUsb_GetNumCameras()
        //
        static __declspec(dllexport) int fcUsb_cmd_startExposure(int camNum);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_startGuiderExposure(int camNum);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_abortExposure(int camNum);
        ...
        // valid camNum is 1 -> fcUsb_GetNumCameras()
        //
        static __declspec(dllexport) int fcUsb_cmd_abortGuiderExposure(int camNum);
        ...
        //
        static __declspec(dllexport) UInt16 fcUsb_cmd_getState(int camNum);
        ...
        //  2 - processing image
        //
        static __declspec(dllexport) UInt16 fcUsb_cmd_getGuiderState(int camNum);
        ...
        // 0 = off, 1 = on
        //
        static __declspec(dllexport) int fcUsb_cmd_setFrameGrabberTestPattern(int camNum, UInt16 state);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_rdScanLine(int camNum, UInt16 lineNum, UInt16 Xmin, UInt16 Xmax, UInt16 *lineBuffer);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_setRoi(int camNum, UInt16 left, UInt16 top, UInt16 right, UInt16 bottom);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_setBin(int camNum, UInt16 binMode);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_setRelay(int camNum, int whichRelay);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_clearRelay(int camNum, int whichRelay);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_pulseRelay(int camNum, int whichRelay, int onMs, int offMs, bool repeats);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_setTemperature(int camNum, SInt16 theTemp);
        ...
        //
        static __declspec(dllexport) SInt16 fcUsb_cmd_getTemperature(int camNum);



        // will return a number from 0 -> 100;  To be interpreted as a percent.
        //
        static __declspec(dllexport) UInt16 fcUsb_cmd_getTECPowerLevel(int camNum);


        // will return TRUE if the TEC power cable is plugged into the camera
        //
        static __declspec(dllexport) bool fcUsb_cmd_getTECInPowerOK(int camNum);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_turnOffCooler(int camNum);
        ...
        // here to read a specific scan line from the camera's frame grabber buffer
        //
        static __declspec(dllexport) int fcUsb_cmd_rdScanLineQueue(int camNum, UInt16 lineNum, UInt16 Xmin, UInt16 Xmax, UInt16 *lineBuffer);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_getRawFrame(int camNum, UInt16 numRows, UInt16 numCols, UInt16 *frameBuffer);
        ...
        // this routine is not supported on the PC platform at this time.
        // DO NOT USE
        ...
        // Y = 1 -> numPixelshigh
        //
        static __declspec(dllexport) int fcUsb_cmd_readRawFrame(int camNum, UInt16 numRows, UInt16 numCols, UInt16 *frameBuffer);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_setReadMode(int camNum, int DataXfrReadMode, int DataFormat);
        ...
        static __declspec(dllexport) void fcUsb_setStarfishDefaultRegs(int camNum);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_setCameraGain(int camNum, UInt16 theGain);
        ...
        //
        static __declspec(dllexport) int fcUsb_cmd_setCameraOffset(int camNum, UInt16 theOffset);
        ...
        //
        static __declspec(dllexport) void fcUsb_cmd_setImageFilter(int camNum, int theImageFilter);
        ...
        //
        static __declspec(dllexport) UInt16 fcUsb_cmd_getBlackPedestal(int camNum);
        ...
        //
        //
        static __declspec(dllexport) void fcUsb_cmd_setCameraProperty(int camNum, int propertyType, int propertyValue);
