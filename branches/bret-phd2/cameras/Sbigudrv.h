...
typedef enum { ST7_CAMERA=4, ST8_CAMERA, ST5C_CAMERA, TCE_CONTROLLER,
  ...
  ST4K_CAMERA, STT_CAMERA, STI_CAMERA, ST8300B_CAMERA, NEXT_CAMERA, NO_CAMERA=0xFFFF } CAMERA_TYPE;
...
typedef enum { DCP_USB_FIFO_ENABLE, DCP_CALL_JOURNAL_ENABLE,
    ...
    DCP_OVERSCAN_ROWSCOLS, DCP_PIXEL_PIPELINE_ENABLE, DCP_LAST } DRIVER_CONTROL_PARAM;
...
#define MIN_ST8300_EXPOSURE  9  /* Minimum exposure in 1/100ths second */
